...
[![Daffodil Build](https://github.com/graycoreio/daffodil/actions/workflows/build.yml/badge.svg)](https://github.com/graycoreio/daffodil/actions/workflows/build.yml)
...
- To use Daffodil to build your own Ecommerce store, follow the steps in the [Installation instructions](/docs/guides/getting-started.md).

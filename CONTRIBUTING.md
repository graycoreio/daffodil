...
We would love for you to contribute to Daffodil and help make it even better than it is
...
Do not open issues for general support questions as we want to keep GitHub issues for bug reports and feature requests. You've got much better chances of getting your question answered on [Stack Overflow](https://stackoverflow.com/questions/tagged/daffodil) where the questions should be tagged with tag `daffodil`.
...
You can file new issues by filling out our [new issue form](https://github.com/graycoreio/daffodil/issues/new).
...
### <a name="ai-guidelines"></a> AI Submission Guidelines

> [!CAUTION]
> Please read this carefully.

We encourage developers that use AI to contribute to Daffodil. Daffodil's codebase is large, contains thousands of commits, and many complicated ideas and concepts — many of which are likely foreign to you. We're very glad that new contributors are able to further engage with the codebase through AI where they would not have been able to before. However, just like before AI, the same concepts apply: 

1. Don't be lazy. We have to read your code. 
2. Don't be lazy. We have to read your code in the future.
3. Don't be lazy. We have to understand your code.
4. Don't be lazy. We have to understand your code in the future.
5. Don't be lazy. Noise drowns progress.

Your AI-generated code should be indistinguishable from code written by a human. If it isn't, there's a high-likelihood that we will respectfully close your issue/pull request. We want to help you, however, we also want you to help you.

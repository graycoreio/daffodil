...
@Component({selector: 'fd-add-to-cart', template: ''})
...
@Component({ selector: 'fd-add-to-cart-notification', template: ''})
...
describe('ProductViewComponent', () => {
  ...
  describe('when loading$ is false', () => {
    ...
    it('should render <fd-product>', () => {
      expect(productComponent).not.toBeNull();
    });

    it('should not render fd-loading-icon', () => {
      expect(fixture.debugElement.query(By.css('fd-loading-icon'))).toBeNull();
    });
  });
  ...
  describe('when loading$ is true', () => {
    ...
    beforeEach(() => {
      ...
      productComponent = fixture.debugElement.query(By.css('fd-product'));
    });

    it('should  not render <fd-product>', () => {
      expect(productComponent).toBeNull();
    });
    
    it('should render fd-loading-icon', () => {
      expect(fixture.debugElement.query(By.css('fd-loading-icon'))).not.toBeNull();
    });
  });
});

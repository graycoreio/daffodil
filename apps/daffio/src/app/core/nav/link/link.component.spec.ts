...
import { DaffioNavLinkComponent } from './link.component';
...
@Component({
  template: '<daffio-nav-link></daffio-nav-link>',
  imports: [
...
describe('DaffioNavLinkComponent', () => {
  let component: WrapperComponent;
  let fixture: ComponentFixture<WrapperComponent>;
  let docsNavContainer: DaffioNavLinkComponent;
  ...
  beforeEach(() => {
    ...
    docsNavContainer = fixture.debugElement.query(By.css('daffio-nav-link')).componentInstance;
  });

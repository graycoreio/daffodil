 ...
 */
export const DAFFIO_EXAMPLES_CONTENT_COMPONENT_MAP = new InjectionToken<Map<string, DaffDocsExampleContent['component']>>('DAFFIO_EXAMPLES_CONTENT_COMPONENT_MAP', {
  providedIn: 'any',

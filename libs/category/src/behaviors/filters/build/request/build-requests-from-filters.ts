 ...
 */
export function daffCategoryBuildRequestsFromFilters(filters: Dict<DaffCategoryFilter>): DaffCategoryFilterRequest[] {
  return Object.values(filters).reduce((acc: DaffCategoryFilterRequest[], filter) => {

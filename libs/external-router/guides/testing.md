...
You may want to test how exactly your two canMatches interact with each other along with other guards that you have.
...
describe('daffExternalMatcherTypeGuard', () => {
	beforeEach(() => {
		TestBed.configureTestingModule({
			imports: [DaffExternalRouterDriverTestingModule.forRoot(TESTING_CONFIG)],
			providers: [
				provideRouter([
					{
						path: '**',

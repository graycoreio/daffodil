export { HeroThemingExampleComponent } from './hero-theming/hero-theming.component';
export { HeroTextAlignmentExampleComponent } from './hero-text-alignment/hero-text-alignment.component';

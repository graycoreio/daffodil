export { BasicSwitchExampleComponent } from './basic-switch/basic-switch.component';
export { DisabledSwitchExampleComponent } from './disabled-switch/disabled-switch.component';

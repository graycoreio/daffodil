 ...
 */
export const DAFF_SEO_CANONICAL_URL_ROUTER_UPDATES = new InjectionToken<DaffSeoUpdateEventPair<Event, string>[]>('DAFF_SEO_CANONICAL_URL_ROUTER_UPDATES', { factory: () => []});

...
export class DaffCartShippingAddressLoadSuccess<T extends DaffCartAddress> implements Action {
...
export class DaffCartShippingAddressUpdate<T extends DaffCartAddress> implements Action {
  readonly type = DaffCartShippingAddressActionTypes.CartShippingAddressUpdateAction;

  constructor(public payload: Partial<T>) {}
}

export class DaffCartShippingAddressUpdateSuccess<T extends DaffCart> implements Action {

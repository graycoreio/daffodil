...
export class DaffCartShippingMethodsLoadSuccess<T extends DaffCartShippingRate> implements Action {
...
export type DaffCartShippingMethodsActions<T extends DaffCartShippingRate> =

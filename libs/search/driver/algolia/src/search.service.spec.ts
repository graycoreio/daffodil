...
import { provideDaffSearchAlgoliaDrivers } from '@daffodil/search/driver/algolia';
...
describe('@daffodil/search/driver/algolia | DaffSearchAlgoliaDriver', () => {
  let service: DaffSearchAlgoliaDriver;

  beforeEach(() => {
    TestBed.configureTestingModule({
      providers: [
        DaffSearchAlgoliaDriver,
        ...provideDaffSearchAlgoliaDrivers<TestDriver1 | TestDriver2>(TestDriver1, TestDriver2),
      ],
    });

    service = TestBed.inject(DaffSearchAlgoliaDriver);
  });

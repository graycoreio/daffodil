export { DaffProductReviewsFacadeInterface } from './product-reviews/product-facade.interface';
export { DaffProductReviewsFacade } from './product-reviews/product.facade';

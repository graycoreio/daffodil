...
export class MockConfigurableProduct extends MockProduct implements DaffConfigurableProduct {
  private stubPriceVariant1 = faker.number.int({ min: 1, max: 1500 });
  private stubDiscountVariant1 = faker.number.int({ min: 0, max: this.stubPriceVariant1 - 1 });
  private stubPriceVariant2 = faker.number.int({ min: 1, max: 1500 });
  private stubDiscountVariant2 = faker.number.int({ min: 0, max: this.stubPriceVariant2 - 1 });
  private stubPriceVariant3 = faker.number.int({ min: 1, max: 1500 });
  private stubDiscountVariant3 = faker.number.int({ min: 0, max: this.stubPriceVariant3 - 1 });

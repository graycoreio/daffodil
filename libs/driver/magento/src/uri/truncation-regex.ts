 ...
 */
export const MAGENTO_TRUNCATE_FILE_EXTENSION_REGEX = /(?<uri>.+)\.(.*)$/;
 ...
 */
export const MAGENTO_TRUNCATE_LEADING_PATH_SEGMENTS_REGEX = /(.*\/)?(?<uri>.+)$/;
 ...
 */
export const MAGENTO_TRUNCATE_LEADING_SLASH_REGEX = /^\/?(?<uri>.+)$/;

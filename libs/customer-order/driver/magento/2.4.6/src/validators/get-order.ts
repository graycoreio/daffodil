...
import { MagentoGetCustomerOrderResponse } from '../queries/public_api';

export const validateGetCustomerOrderResponse = (response: Apollo.QueryResult<MagentoGetCustomerOrderResponse>) => {

...
import { magentoSearchCategoryResultTransform } from './category-result';

// TODO: this test and testing package

describe('magentoSearchCategoryResultTransform', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      providers: [
        magentoSearchCategoryResultTransform,
      ],
    });

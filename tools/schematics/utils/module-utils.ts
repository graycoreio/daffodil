...
function getPackageForProvider(providerName: string): string {
  ...
  const providerMap: { [key: string]: string } = {
    ...
    provideDaffExternalRouterMagentoDriver: '@daffodil/external-router/driver/magento/driver',
    getDaffExternalRouterMagentoDriverService: '@daffodil/external-router/driver/magento/driver',

...
interface Options extends DaffVersioningProject {}

const nxProjects = async (dir: string) => {
...
/**
 * A builder that adds build conditions to the project for the specified driver versions.
 */

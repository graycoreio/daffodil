 ...
 */
class DaffProductFactory extends DaffModelFactory {
    constructor() {
        super(MockProduct);
    }
}
 ...
 */
class DaffConfigurableProductFactory extends DaffModelFactory {
    constructor() {
 ...
 */
class DaffProductImageFactory extends DaffModelFactory {
    constructor() {
 ...
 */
class DaffInMemoryBackendProductService {
    /**
 ...
 */
class DaffTestingProductService {
    /**
     * @param {?} productFactory
     * @param {?} productImageFactory
     */
 ...
 * \@Param HttpClient
 */
class DaffInMemoryProductService {
    /**
     * @param {?} http
     */
    constructor(http) {
 ...
 */
class DaffProductInMemoryDriverModule {
    /**
     * @return {?}
     */
    static forRoot() {
 ...
 */
class DaffProductTestingDriverModule {
    /**
     * @return {?}
     */
    static forRoot() {
 ...
 * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class MockDaffConfigurableProductFacade {
    /**
     * @param {?} id
     * @return {?}
     */
 ...
 * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class MockDaffCompositeProductFacade {
    /**
     * @param {?} id
     * @param {?=} configuration
     * @return {?}
 ...
 * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class DaffProductTestingModule {
}
...
class MagentoCoreProductFactory extends DaffModelFactory {
    constructor() {
 ...
 * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class MockMagentoSimpleProduct extends MockMagentoCoreProduct {
    constructor() {
        super(...arguments);
        this.__typename = MagentoProductTypeEnum.SimpleProduct;
    }
...
class MagentoSimpleProductFactory extends DaffModelFactory {
    constructor() {
 ...
 * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class MockMagentoBundledProduct extends MockMagentoCoreProduct {
    constructor() {
        super(...arguments);
...
class MagentoBundledProductFactory extends DaffModelFactory {
    constructor() {
 ...
 * @suppress {checkTypes,constantProperty,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class MockMagentoConfigurableProduct extends MockMagentoCoreProduct {
    constructor() {
        super(...arguments);
        this.priceVariant1 = random.number({ min: 1, max: 1000 });
        this.discountVariant1 = random.number({ min: 0, max: this.priceVariant1 - 1 });
        this.priceVariant2 = random.number({ min: 1, max: 1000 });
        this.discountVariant2 = random.number({ min: 0, max: this.priceVariant2 - 1 });
        this.priceVariant3 = random.number({ min: 1, max: 1000 });
        this.discountVariant3 = random.number({ min: 0, max: this.priceVariant3 - 1 });
...
class MagentoConfigurableProductFactory extends DaffModelFactory {
    constructor() {

 ...
 * @type {?}
 */
const DaffCartPaymentMethodIdMap = new InjectionToken('DaffCartPaymentMethodIdMap', {
    factory: (/**
     * @return {?}
     */
    () => ({}))
 ...
 * @type {?}
 */
const DAFF_CART_ERROR_MATCHER = new InjectionToken('DAFF_CART_ERROR_MATCHER', { factory: (/**
     * @return {?}
     */

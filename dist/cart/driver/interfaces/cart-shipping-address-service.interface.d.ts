 ...
 */
export interface DaffCartShippingAddressServiceInterface<T extends DaffCartAddress = DaffCartAddress, V extends DaffCart = DaffCart> {
    /**
...
export declare const DaffCartShippingAddressDriver: InjectionToken<DaffCartShippingAddressServiceInterface<any, any>>;

 ...
 */
export interface DaffCartAddressServiceInterface<T extends DaffCartAddress = DaffCartAddress, V extends DaffCart = DaffCart> {
    /**
     * Update the billing and shipping address of a cart
     */
    update(cartId: V['id'], address: Partial<T>): Observable<Partial<V>>;
}
export declare const DaffCartAddressDriver: InjectionToken<DaffCartAddressServiceInterface<any, any>>;

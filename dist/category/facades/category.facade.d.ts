 ...
 */
export declare class DaffCategoryFacade<T extends DaffCategoryRequest = DaffCategoryRequest, V extends DaffGenericCategory<V> = DaffCategory, U extends DaffCategoryPageConfigurationState<T> = DaffCategoryPageConfigurationState<T>, W extends DaffProduct = DaffProduct> implements DaffCategoryFacadeInterface<T, V, U, W> {
    private store;
   ...
   */
    ...
    constructor(store: Store<DaffCategoryReducersState<T, V, U>>);
    /**

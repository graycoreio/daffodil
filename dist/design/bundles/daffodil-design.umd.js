(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@fortawesome/free-solid-svg-icons'), require('@fortawesome/angular-fontawesome'), require('@angular/platform-browser'), require('@angular/forms'), require('@angular/animations'), require('@angular/cdk/portal'), require('@angular/cdk/overlay'), require('rxjs/operators'), require('rxjs'), require('@angular/cdk/a11y')) :
    typeof define === 'function' && define.amd ? define('@daffodil/design', ['exports', '@angular/core', '@angular/common', '@fortawesome/free-solid-svg-icons', '@fortawesome/angular-fontawesome', '@angular/platform-browser', '@angular/forms', '@angular/animations', '@angular/cdk/portal', '@angular/cdk/overlay', 'rxjs/operators', 'rxjs', '@angular/cdk/a11y'], factory) :
    (global = global || self, factory((global.daffodil = global.daffodil || {}, global.daffodil.design = {}), global.ng.core, global.ng.common, global.freeSolidSvgIcons, global.angularFontawesome, global.ng.platformBrowser, global.ng.forms, global.ng.animations, global.ng.cdk.portal, global.ng.cdk.overlay, global.rxjs.operators, global.rxjs, global.ng.cdk.a11y));
}(this, function (exports, core, common, freeSolidSvgIcons, angularFontawesome, platformBrowser, forms, animations, portal, overlay, operators, rxjs, a11y) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var DaffPrefixDirective = /** @class */ (function () {
        ...
        DaffPrefixDirective.propDecorators = {
            class: [{ type: core.HostBinding, args: ['class.daff-prefix',] }]
        };
    ...
    var DaffSuffixDirective = /** @class */ (function () {
        ...
        DaffSuffixDirective.propDecorators = {
            class: [{ type: core.HostBinding, args: ['class.daff-suffix',] }]
        };
    ...
    function daffSuffixableMixin(Base) {
        var Suffixable = /** @class */ (function (_super) {
            ...
            Suffixable.propDecorators = {
                _suffix: [{ type: core.ContentChild, args: [DaffSuffixDirective, { static: true },] }]
            };
            return Suffixable;
        }(Base));
        if (false) {
    ...
    function daffPrefixableMixin(Base) {
        var Prefixable = /** @class */ (function (_super) {
            ...
            Prefixable.propDecorators = {
                _prefix: [{ type: core.ContentChild, args: [DaffPrefixDirective, { static: true },] }]
            };
            return Prefixable;
        }(Base));
        if (false) {
    ...
    var DaffButtonComponent = /** @class */ (function (_super) {
        ...
        DaffButtonComponent.propDecorators = {
            ...
            button: [{ type: core.HostBinding, args: ['class.daff-button',] }],
            stroked: [{ type: core.HostBinding, args: ['class.daff-stroked-button',] }],
            raised: [{ type: core.HostBinding, args: ['class.daff-raised-button',] }],
            icon: [{ type: core.HostBinding, args: ['class.daff-icon-button',] }],
            underline: [{ type: core.HostBinding, args: ['class.daff-underline-button',] }]
        };
    ...
    var DaffFormFieldComponent = /** @class */ (function () {
        ...
        DaffFormFieldComponent.propDecorators = {
            ...
            _control: [{ type: core.ContentChild, args: [DaffFormFieldControl, { static: false },] }]
        };
    ...
    var DaffCheckboxComponent = /** @class */ (function () {
        function DaffCheckboxComponent(_cdRef) {
             ...
             */
            this.becameChecked = new core.EventEmitter();
            this.becameUnchecked = new core.EventEmitter();
            /**
        ...
        */
        ...
        DaffCheckboxComponent.propDecorators = {
            nativeCheckbox: [{ type: core.ViewChild, args: ['inputElement', { static: true, read: core.ElementRef },] }],
            name: [{ type: core.Input }],
            value: [{ type: core.Input }],
            checked: [{ type: core.Input }],
            id: [{ type: core.Input }],
            label: [{ type: core.Input, args: ['aria-label',] }],
            labeledBy: [{ type: core.Input, args: ['aria-labelledby',] }],
            becameChecked: [{ type: core.Output }],
            becameUnchecked: [{ type: core.Output }],
            role: [{ type: core.HostBinding, args: ['attr.role',] }],
            focusClass: [{ type: core.HostBinding, args: ['class.focused',] }],
            disabledClass: [{ type: core.HostBinding, args: ['class.disabled',] }]
        };
    ...
    var DaffCheckboxSetComponent = /** @class */ (function () {
        function DaffCheckboxSetComponent() {
             ...
             */
            this.role = 'group';
            this.valueList = new core.EventEmitter();
        }
        /**
         * @return {?}
         */
        ...
        DaffCheckboxSetComponent.propDecorators = {
            ...
            name: [{ type: core.Input }],
            role: [{ type: core.HostBinding, args: ['attr.role',] }],
            checkboxes: [{ type: core.ContentChildren, args: [DaffCheckboxComponent,] }],
            valueList: [{ type: core.Output }]
        };
    ...
    var DaffContainerComponent = /** @class */ (function (_super) {
        ...
        DaffContainerComponent.propDecorators = {
            size: [{ type: core.Input }],
            class: [{ type: core.HostBinding, args: ['class.daff-container',] }]
        };
    ...
    var DaffLoadingIconComponent = /** @class */ (function (_super) {
        ...
        DaffLoadingIconComponent.propDecorators = {
            ...
            class: [{ type: core.HostBinding, args: ['class.daff-loading-icon',] }],
            maxWidth: [{ type: core.HostBinding, args: ['style.max-width',] }]
        };
    ...
    var daffProgressIndicatorAnimation = {
        fill: animations.trigger('fill', [
            animations.state('*', animations.style({ width: '{{ percentage }}%' }), { params: { percentage: 0 } }),
            animations.transition('* <=> *', animations.animate(1000))
        ])
    };
    ...
    var DaffProgressIndicatorComponent = /** @class */ (function (_super) {
        ...
        function DaffProgressIndicatorComponent(elementRef, renderer) {
             ...
             */
            _this.finished = new core.EventEmitter();
            return _this;
        }
        /**
        ...
        DaffProgressIndicatorComponent.propDecorators = {
            class: [{ type: core.HostBinding, args: ['class.daff-progress-indicator',] }],
            color: [{ type: core.Input }],
    ...
    var DaffRadioComponent = /** @class */ (function () {
        ...
        DaffRadioComponent.ctorParameters = function () { return [
            { type: DaffRadioSetComponent, decorators: [{ type: core.Optional }] }
        ]; };
    ...
    var daffAccordionAnimations = {
        openAccordion: animations.trigger('openAccordion', [
            ...
            animations.transition('void <=> open', animations.animate('150ms ease-in'))
        ])
    };
    ...
    var DaffAccordionItemComponent = /** @class */ (function () {
        ...
        DaffAccordionItemComponent.propDecorators = {
            class: [{ type: core.HostBinding, args: ['class.daff-accordion-item',] }],
            initiallyActive: [{ type: core.Input }]
        };
    ...
    var DaffAccordionItemTitleDirective = /** @class */ (function () {
        ...
        DaffAccordionItemTitleDirective.propDecorators = {
            class: [{ type: core.HostBinding, args: ['class.daff-accordion-item__title',] }]
        };
    ...
    var DaffAccordionItemContentDirective = /** @class */ (function () {
        ...
        DaffAccordionItemContentDirective.propDecorators = {
            class: [{ type: core.HostBinding, args: ['class.daff-accordion-item__content',] }]
        };
    ...
    var DaffArticleComponent = /** @class */ (function () {
        ...
        DaffArticleComponent.propDecorators = {
            class: [{ type: core.HostBinding, args: ['class.daff-article',] }],
            role: [{ type: core.HostBinding, args: ['attr.role',] }]
        };
    ...
    var DaffArticleTitleDirective = /** @class */ (function () {
        ...
        DaffArticleTitleDirective.propDecorators = {
            class: [{ type: core.HostBinding, args: ['class.daff-article__title',] }]
        };
    ...
    var DaffArticleLeadDirective = /** @class */ (function () {
        ...
        DaffArticleLeadDirective.propDecorators = {
            class: [{ type: core.HostBinding, args: ['class.daff-article__lead',] }]
        };
    ...
    var DaffArticleMetaDirective = /** @class */ (function () {
        ...
        DaffArticleMetaDirective.propDecorators = {
            class: [{ type: core.HostBinding, args: ['class.daff-article__meta',] }]
        };
    ...
    var daffBackdropAnimations = {
        fadeBackdrop: animations.trigger('fadeBackdrop', [
            animations.transition(':enter', [
                animations.style({ opacity: 0 }),
                animations.animate(animationDuration + ' ' + backdropTransitionIn, animations.style({ opacity: 1 })),
            ]),
            animations.transition(':leave', [
                animations.animate(animationDuration + ' ' + backdropTransitionOut, animations.style({ opacity: 0 }))
            ])
        ])
    };
    ...
    var DaffBackdropComponent = /** @class */ (function () {
        ...
        DaffBackdropComponent.propDecorators = {
            ...
            onBackdropClicked: [{ type: core.HostBinding, args: ['@fadeBackdrop',] }, { type: core.HostListener, args: ['click',] }]
        };
    ...
    var DaffButtonSetComponent = /** @class */ (function () {
        ...
        DaffButtonSetComponent.propDecorators = {
            class: [{ type: core.HostBinding, args: ['class.daff-button-set',] }]
        };
    ...
    var DaffImageListComponent = /** @class */ (function () {
        ...
        DaffImageListComponent.propDecorators = {
            class: [{ type: core.HostBinding, args: ['class.daff-image-list',] }]
        };
    ...
    var DaffLinkSetComponent = /** @class */ (function () {
        ...
        DaffLinkSetComponent.propDecorators = {
            class: [{ type: core.HostBinding, args: ['class.daff-link-set',] }]
        };
    ...
    var DaffLinkSetSubheadingDirective = /** @class */ (function () {
        ...
        DaffLinkSetSubheadingDirective.propDecorators = {
            class: [{ type: core.HostBinding, args: ['class.daff-link-set__subheading',] }]
        };
    ...
    var DaffLinkSetHeadingDirective = /** @class */ (function () {
        ...
        DaffLinkSetHeadingDirective.propDecorators = {
            class: [{ type: core.HostBinding, args: ['class.daff-link-set__heading',] }]
        };
    ...
    var DaffLinkSetItemComponent = /** @class */ (function () {
        ...
        DaffLinkSetItemComponent.propDecorators = {
            class: [{ type: core.HostBinding, args: ['class.daff-link-set__item',] }]
        };
    ...
    var DaffListComponent = /** @class */ (function () {
        ...
        DaffListComponent.propDecorators = {
            ...
            list: [{ type: core.HostBinding, args: ['class.daff-list',] }],
            multiline: [{ type: core.HostBinding, args: ['class.daff-list--multi-line',] }],
            link: [{ type: core.HostBinding, args: ['class.daff-list--link',] }],
            navigation: [{ type: core.HostBinding, args: ['class.daff-list--navigation',] }],
            nav: [{ type: core.HostBinding, args: ['class.daff-nav-list',] }],
            role: [{ type: core.HostBinding, args: ['attr.role',] }]
        };
    ...
    var DaffListSubheaderDirective = /** @class */ (function () {
        ...
        DaffListSubheaderDirective.propDecorators = {
            class: [{ type: core.HostBinding, args: ['class.daff-list__subheader',] }]
        };
    ...
    var DaffListItemComponent = /** @class */ (function () {
        ...
        DaffListItemComponent.propDecorators = {
            class: [{ type: core.HostBinding, args: ['class.daff-list-item',] }],
            _prefix: [{ type: core.ContentChild, args: [DaffPrefixDirective, { static: false },] }],
            _suffix: [{ type: core.ContentChild, args: [DaffSuffixDirective, { static: false },] }],
            role: [{ type: core.HostBinding, args: ['attr.role',] }]
        };
    ...
    var daffFadeAnimations = {
        fade: animations.trigger('fade', [
            animations.state('open', animations.style({ opacity: 1, })),
            animations.state('closed', animations.style({ opacity: 0 })),
            animations.transition('open <=> closed', animations.animate('400ms cubic-bezier(0.25, 0.8, 0.25, 1)')),
        ]),
    };
    ...
    var DaffModalComponent = /** @class */ (function () {
        function DaffModalComponent() {
             ...
             */
            this.animationCompleted = new core.EventEmitter();
            /**
             * Event fired when the close animation is completed.
             */
            this.closedAnimationCompleted = new core.EventEmitter();
            /**
        ...
        DaffModalComponent.propDecorators = {
            ...
            modalClass: [{ type: core.HostBinding, args: ['class.daff-modal',] }],
            fadeState: [{ type: core.HostBinding, args: ['@fade',] }],
            animationDone: [{ type: core.HostListener, args: ['@fade.done', ['$event'],] }]
        };
    ...
    var DaffModalHeaderComponent = /** @class */ (function () {
        ...
        DaffModalHeaderComponent.propDecorators = {
            class: [{ type: core.HostBinding, args: ['class.daff-modal-header',] }]
        };
    ...
    var DaffModalTitleDirective = /** @class */ (function () {
        ...
        DaffModalTitleDirective.propDecorators = {
            class: [{ type: core.HostBinding, args: ['class.daff-modal-title',] }]
        };
    ...
    var DaffModalService = /** @class */ (function () {
        ...
        function (overlayRef) {
            /** @type {?} */
            var modal = overlayRef.attach(new portal.ComponentPortal(DaffModalComponent));
        ...
        function (component, modal) {
            modal.instance.attachContent(new portal.ComponentPortal(component));
        };
        /**
         * @private
         * @return {?}
        ...
        function () {
            return this.overlay.create({
                hasBackdrop: true,
                positionStrategy: new overlay.GlobalPositionStrategy()
                    .centerHorizontally()
                    .centerVertically(),
        ...
        /** @nocollapse */ DaffModalService.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function DaffModalService_Factory() { return new DaffModalService(core.ɵɵinject(overlay.Overlay)); }, token: DaffModalService, providedIn: DaffModalModule });
    ...
    var DaffNavbarComponent = /** @class */ (function (_super) {
        ...
        DaffNavbarComponent.propDecorators = {
            color: [{ type: core.Input }],
            shadowed: [{ type: core.Input }],
            shadowClass: [{ type: core.HostBinding, args: ['class.daff-navbar--shadowed',] }],
            hostClass: [{ type: core.HostBinding, args: ['class.daff-navbar',] }]
        };
    ...
    var DaffPaginatorComponent = /** @class */ (function (_super) {
        ...
        function DaffPaginatorComponent(elementRef, renderer) {
             ...
             * \@docs-private
             */
            _this.faChevronRight = freeSolidSvgIcons.faChevronRight;
            /**
             * \@docs-private
             */
            _this.faChevronLeft = freeSolidSvgIcons.faChevronLeft;
            /**
             * Emits when the current page changes with the new current page.
             */
            _this.notifyPageChange = new core.EventEmitter();
            /** @type {?} */
        ...
        DaffPaginatorComponent.propDecorators = {
            class: [{ type: core.HostBinding, args: ['class.daff-paginator',] }],
            role: [{ type: core.HostBinding, args: ['attr.role',] }],
            color: [{ type: core.Input }],
            numberOfPages: [{ type: core.Input }],
            currentPage: [{ type: core.Input }],
            notifyPageChange: [{ type: core.Output }]
        };
    ...
    var DaffQtyDropdownComponent = /** @class */ (function () {
        function DaffQtyDropdownComponent(renderer) {
            ...
            this.qtyChanged = new core.EventEmitter();
            /**
             * \@docs-private
             */
            this.onChange = (/**
    ...
    var DaffSidebarComponent = /** @class */ (function () {
        function DaffSidebarComponent(_elementRef, _ngZone) {
             ...
             */
            this.escapePressed = new core.EventEmitter();
            /**
             ...
             */
            function () {
                rxjs.fromEvent(_this._elementRef.nativeElement, 'keydown').pipe(operators.filter((/**
                 * @param {?} event
                 * @return {?}
                 */
        ...
        DaffSidebarComponent.propDecorators = {
            escapePressed: [{ type: core.Output }]
        };
    ...
    var daffSidebarAnimations = {
        transformSidebar: animations.trigger('transformSidebar', [
            ...
            animations.transition('open => closed', animations.animate(duration + ' ' + sidebarAnimateOutTransition)),
            animations.transition('closed => open', animations.animate(duration + ' ' + sidebarAnimateInTransition))
        ]),
        transformContent: animations.trigger('transformContent', [
    ...
    var DaffSidebarViewportComponent = /** @class */ (function () {
        ...
        DaffSidebarViewportComponent.propDecorators = {
            sidebar: [{ type: core.ContentChild, args: [DaffSidebarComponent, { static: false },] }],
            mode: [{ type: core.Input }],
            backdropIsVisible: [{ type: core.Input }],
    ...
    var DaffHeroComponent = /** @class */ (function (_super) {
        ...
        DaffHeroComponent.propDecorators = {
            ...
            size: [{ type: core.Input }],
            color: [{ type: core.Input }],
            class: [{ type: core.HostBinding, args: ['class.daff-hero',] }],
            centered: [{ type: core.HostBinding, args: ['class.daff-hero--centered',] }],
            small: [{ type: core.HostBinding, args: ['class.daff-hero--small',] }],
            compact: [{ type: core.HostBinding, args: ['class.daff-hero--compact',] }]
        };
    ...
    var DaffHeroSubtitleDirective = /** @class */ (function () {
        ...
        DaffHeroSubtitleDirective.propDecorators = {
            class: [{ type: core.HostBinding, args: ['class.daff-hero__subtitle',] }]
        };
    ...
    var DaffHeroTitleDirective = /** @class */ (function () {
        ...
        DaffHeroTitleDirective.propDecorators = {
            class: [{ type: core.HostBinding, args: ['class.daff-hero__title',] }]
        };
    ...
    var DaffCalloutComponent = /** @class */ (function (_super) {
        ...
        DaffCalloutComponent.propDecorators = {
            ...
            layout: [{ type: core.Input }],
            size: [{ type: core.Input }],
            class: [{ type: core.HostBinding, args: ['class.daff-callout',] }],
            centered: [{ type: core.HostBinding, args: ['class.daff-callout--centered',] }],
            compact: [{ type: core.HostBinding, args: ['class.daff-callout--compact',] }]
        };
    ...
    var DaffCalloutTitleDirective = /** @class */ (function () {
        ...
        DaffCalloutTitleDirective.propDecorators = {
            class: [{ type: core.HostBinding, args: ['class.daff-callout__title',] }]
        };
    ...
    var DaffCalloutSubtitleDirective = /** @class */ (function () {
        ...
        DaffCalloutSubtitleDirective.propDecorators = {
            class: [{ type: core.HostBinding, args: ['class.daff-callout__subtitle',] }]
        };
    ...
    var DaffFeatureComponent = /** @class */ (function () {
        ...
        DaffFeatureComponent.propDecorators = {
            class: [{ type: core.HostBinding, args: ['class.daff-feature',] }],
            mode: [{ type: core.Input }],
            compact: [{ type: core.HostBinding, args: ['class.daff-feature--compact',] }],
            normal: [{ type: core.HostBinding, args: ['class.daff-feature--normal',] }]
        };
    ...
    var DaffFeatureTitleDirective = /** @class */ (function () {
        ...
        DaffFeatureTitleDirective.propDecorators = {
            class: [{ type: core.HostBinding, args: ['class.daff-feature__title',] }]
        };
    ...
    var DaffFeatureSubtitleDirective = /** @class */ (function () {
        ...
        DaffFeatureSubtitleDirective.propDecorators = {
            class: [{ type: core.HostBinding, args: ['class.daff-feature__subtitle',] }]
        };
    ...
    var DaffFeatureIconDirective = /** @class */ (function () {
        ...
        DaffFeatureIconDirective.propDecorators = {
            class: [{ type: core.HostBinding, args: ['class.daff-feature__icon',] }]
        };
    ...
    var DaffFeatureSubheaderDirective = /** @class */ (function () {
        ...
        DaffFeatureSubheaderDirective.propDecorators = {
            class: [{ type: core.HostBinding, args: ['class.daff-feature__subheader',] }]
        };
    ...
    var DaffCardComponent = /** @class */ (function (_super) {
        ...
        DaffCardComponent.propDecorators = {
            color: [{ type: core.Input }],
            class: [{ type: core.HostBinding, args: ['class.daff-card',] }]
        };
    ...
    var DaffCardTitleDirective = /** @class */ (function () {
        ...
        DaffCardTitleDirective.propDecorators = {
            class: [{ type: core.HostBinding, args: ['class.daff-card__title',] }]
        };
    ...
    var DaffCardImageDirective = /** @class */ (function () {
        ...
        DaffCardImageDirective.propDecorators = {
            class: [{ type: core.HostBinding, args: ['class.daff-card__image',] }]
        };
    ...
    exports.DaffAccordionComponent = DaffAccordionComponent;
    exports.DaffAccordionItemComponent = DaffAccordionItemComponent;
    exports.DaffAccordionItemContentDirective = DaffAccordionItemContentDirective;
    exports.DaffAccordionItemTitleDirective = DaffAccordionItemTitleDirective;
    exports.DaffAccordionModule = DaffAccordionModule;
    exports.DaffArticleComponent = DaffArticleComponent;
    exports.DaffArticleLeadDirective = DaffArticleLeadDirective;
    exports.DaffArticleMetaDirective = DaffArticleMetaDirective;
    exports.DaffArticleModule = DaffArticleModule;
    exports.DaffArticleTitleDirective = DaffArticleTitleDirective;
    exports.DaffBackdropComponent = DaffBackdropComponent;
    exports.DaffBackdropModule = DaffBackdropModule;
    exports.DaffBreakpoints = DaffBreakpoints;
    exports.DaffButtonComponent = DaffButtonComponent;
    ...
    exports.DaffCalloutLayoutEnum = DaffCalloutLayoutEnum;
    exports.DaffCalloutModule = DaffCalloutModule;
    exports.DaffCalloutSizeEnum = DaffCalloutSizeEnum;
    ...
    exports.DaffCardTitleDirective = DaffCardTitleDirective;
    exports.DaffCheckboxComponent = DaffCheckboxComponent;
    exports.DaffCheckboxModule = DaffCheckboxModule;
    exports.DaffCheckboxSetComponent = DaffCheckboxSetComponent;
    exports.DaffContainerComponent = DaffContainerComponent;
    exports.DaffContainerModule = DaffContainerModule;
    exports.DaffErrorStateMatcher = DaffErrorStateMatcher;
    exports.DaffFeatureComponent = DaffFeatureComponent;
    exports.DaffFeatureIconDirective = DaffFeatureIconDirective;
    exports.DaffFeatureModeEnum = DaffFeatureModeEnum;
    exports.DaffFeatureModule = DaffFeatureModule;
    exports.DaffFeatureSubheaderDirective = DaffFeatureSubheaderDirective;
    exports.DaffFeatureSubtitleDirective = DaffFeatureSubtitleDirective;
    exports.DaffFeatureTitleDirective = DaffFeatureTitleDirective;
    exports.DaffFormFieldComponent = DaffFormFieldComponent;
    ...
    exports.DaffHeroLayoutEnum = DaffHeroLayoutEnum;
    exports.DaffHeroModule = DaffHeroModule;
    exports.DaffHeroSizeEnum = DaffHeroSizeEnum;
    exports.DaffHeroSubtitleDirective = DaffHeroSubtitleDirective;
    exports.DaffHeroTitleDirective = DaffHeroTitleDirective;
    exports.DaffImageComponent = DaffImageComponent;
    exports.DaffImageGalleryComponent = DaffImageGalleryComponent;
    exports.DaffImageGalleryModule = DaffImageGalleryModule;
    exports.DaffImageListComponent = DaffImageListComponent;
    exports.DaffImageListModule = DaffImageListModule;
    exports.DaffImageModule = DaffImageModule;
    exports.DaffInputComponent = DaffInputComponent;
    exports.DaffInputModule = DaffInputModule;
    exports.DaffLinkSetComponent = DaffLinkSetComponent;
    exports.DaffLinkSetHeadingDirective = DaffLinkSetHeadingDirective;
    exports.DaffLinkSetItemComponent = DaffLinkSetItemComponent;
    exports.DaffLinkSetModule = DaffLinkSetModule;
    exports.DaffLinkSetSubheadingDirective = DaffLinkSetSubheadingDirective;
    exports.DaffListComponent = DaffListComponent;
    exports.DaffListItemComponent = DaffListItemComponent;
    exports.DaffListModeEnum = DaffListModeEnum;
    exports.DaffListModule = DaffListModule;
    exports.DaffListSubheaderDirective = DaffListSubheaderDirective;
    exports.DaffLoadingIconComponent = DaffLoadingIconComponent;
    exports.DaffLoadingIconModule = DaffLoadingIconModule;
    exports.DaffModalComponent = DaffModalComponent;
    exports.DaffModalModule = DaffModalModule;
    exports.DaffModalService = DaffModalService;
    exports.DaffNativeSelectComponent = DaffNativeSelectComponent;
    exports.DaffNativeSelectModule = DaffNativeSelectModule;
    exports.DaffNavbarComponent = DaffNavbarComponent;
    exports.DaffNavbarModule = DaffNavbarModule;
    exports.DaffPaginatorComponent = DaffPaginatorComponent;
    exports.DaffPaginatorModule = DaffPaginatorModule;
    exports.DaffPrefixDirective = DaffPrefixDirective;
    exports.DaffPrefixSuffixModule = DaffPrefixSuffixModule;
    exports.DaffProgressIndicatorComponent = DaffProgressIndicatorComponent;
    exports.DaffProgressIndicatorModule = DaffProgressIndicatorModule;
    exports.DaffQtyDropdownComponent = DaffQtyDropdownComponent;
    exports.DaffQtyDropdownModule = DaffQtyDropdownModule;
    exports.DaffRadioComponent = DaffRadioComponent;
    exports.DaffRadioModule = DaffRadioModule;
    exports.DaffRadioSetComponent = DaffRadioSetComponent;
    exports.DaffSidebarComponent = DaffSidebarComponent;
    exports.DaffSidebarModule = DaffSidebarModule;
    exports.DaffSidebarViewportComponent = DaffSidebarViewportComponent;
    exports.DaffStatusEnum = DaffStatusEnum;
    exports.DaffSuffixDirective = DaffSuffixDirective;
    exports.colorInPalette = colorInPalette;
    exports.daffColorMixin = daffColorMixin;
    exports.daffPrefixableMixin = daffPrefixableMixin;
    exports.daffSuffixableMixin = daffSuffixableMixin;
    exports.ɵa = DaffErrorMessageModule;
    exports.ɵb = DaffErrorMessageComponent;
    exports.ɵc = DaffCheckboxControlValueAccessorDirective;
    exports.ɵd = daffProgressIndicatorAnimation;
    exports.ɵe = DaffRadioControlValueAccessorDirective;
    exports.ɵf = DaffRadioRegistry;
    exports.ɵg = daffAccordionAnimations;
    exports.ɵh = daffBackdropAnimations;
    exports.ɵi = daffFadeAnimations;
    exports.ɵj = DaffModalHeaderComponent;
    exports.ɵk = DaffModalTitleDirective;
    exports.ɵl = DaffModalContentComponent;
    exports.ɵm = DaffModalActionsComponent;
    exports.ɵn = daffSidebarAnimations;

    Object.defineProperty(exports, '__esModule', { value: true });

}));
//# sourceMappingURL=daffodil-design.umd.js.map

 ...
 * @type {?}
 */
var DAFF_AUTHORIZENET_ACCEPT_JS_PRODUCTION = new InjectionToken('DAFF_AUTHORIZENET_ACCEPT_JS_PRODUCTION', {
    providedIn: 'root',
    factory: (/**
     * @return {?}
     */
 ...
 * @type {?}
 */
var DAFF_AUTHORIZENET_ERROR_MATCHER = new InjectionToken('DAFF_AUTHORIZENET_ERROR_MATCHER', { factory: (/**
     * @return {?}
     */
